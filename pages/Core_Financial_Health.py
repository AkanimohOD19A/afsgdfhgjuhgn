...
from utils_app import TaxAnalyzer

st.set_page_config(page_title="CFH Q&A Interface", layout="wide")
...
if prompt := st.chat_input("Ask a question about financial health..."):
