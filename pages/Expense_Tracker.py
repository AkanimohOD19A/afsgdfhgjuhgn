...
from utils_expns_app import TaxAnalyzer

st.set_page_config(page_title="ET Q&A Interface", layout="wide")

st.title("Expenses and Exposure Analysis")
...
if prompt := st.chat_input("Ask a question about expenses..."):
